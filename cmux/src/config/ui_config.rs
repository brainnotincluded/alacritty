...
use cmux_config::SerdeReplace;
use cmux_config_derive::{ConfigDeserialize, SerdeReplace};
use cmux_terminal::term::Config as TermConfig;
use cmux_terminal::term::search::RegexSearch;
use cmux_terminal::tty::{Options as PtyOptions, Shell};
...
pub struct UiConfig {
    ...
    /// Config for the cmux_terminal itself.
