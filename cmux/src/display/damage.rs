...
use cmux_terminal::index::Point;
use cmux_terminal::selection::SelectionRange;
use cmux_terminal::term::{LineDamageBounds, TermDamageIterator};
...
/// Iterator which converts `cmux_terminal` damage information into renderer damaged rects.
