...
use cmux_terminal::grid::{BidirectionalIterator, Dimensions};
use cmux_terminal::index::{Boundary, Column, Direction, Line, Point};
use cmux_terminal::term::cell::Hyperlink;
use cmux_terminal::term::search::{Match, RegexIter, RegexSearch};
use cmux_terminal::term::{Term, TermMode};
...
#[cfg(test)]
mod tests {
    use cmux_terminal::index::{Column, Line};
    use cmux_terminal::term::test::mock_term;
    use cmux_terminal::vte::ansi::Handler;
