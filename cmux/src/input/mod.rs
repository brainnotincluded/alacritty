...
use cmux_terminal::event::EventListener;
use cmux_terminal::grid::{Dimensions, Scroll};
use cmux_terminal::index::{Boundary, Column, Direction, Point, Side};
use cmux_terminal::selection::SelectionType;
use cmux_terminal::term::search::Match;
use cmux_terminal::term::{ClipboardType, Term, TermMode};
use cmux_terminal::vi_mode::ViMotion;
use cmux_terminal::vte::ansi::{ClearMode, Handler};
...
mod tests {
    ...
    use cmux_terminal::event::Event as TerminalEvent;
